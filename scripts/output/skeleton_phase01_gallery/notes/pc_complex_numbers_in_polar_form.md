# Notes — `pc_complex_numbers_in_polar_form` (`Complex numbers in polar form`)
...
- **Skill:** Student convert or evaluate for complex numbers in polar form.
- **D=0:** rect↔polar/cis form; simplest numeric/instance (per OpenStax § easy exercises).
...
|---|------|--------------|--------------|-------------|
| 0 | 101 | `$\text{Write }\cos\frac{3\pi}{2}+i\sin\frac{3\pi}{2}\text{ in rectangular form.}$` | `$-i$` | evaluate/rewrite |
| 8 | 101 | `$\text{Write }\cos\frac{3\pi}{2}+i\sin\frac{3\pi}{2}\text{ in rectangular form.}$` | `$-i$` | evaluate/rewrite |
| 16 | 101 | `$\text{Write }\cos\frac{3\pi}{2}+i\sin\frac{3\pi}{2}\text{ in rectangular form.}$` | `$-i$` | evaluate/rewrite |
| 22 | 101 | `$\text{Write }\cos\frac{3\pi}{2}+i\sin\frac{3\pi}{2}\text{ in rectangular form.}$` | `$-i$` | evaluate/rewrite |
...
|------|-----|-------------------------------------------|
| OpenStax Precalculus 2e §3.2 | https://openstax.org/books/precalculus-2e/pages/3-2-complex-numbers | rect↔polar/cis form |

Local HTML (if mined): `textbooks/openstax/html/precalculus-2e/…` or `scripts/output/example_mining/precalculus-2e/stage1/3-2-complex-numbers.md`
...
- **Reuse:** Complex polar constructive.
...
- **Variety:** Old-path table shows one prompt shape across D bands sampled (seed=101) — `$\text{Write }\cos\frac{3\pi}{2}+i\sin\frac{3\pi}{2}\text{ in rectangu...`.
