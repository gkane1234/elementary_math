# Notes — `a2_quadratic_functions_and_inequalities_solving_equations_with_the_quadratic_formula`

> **LIMITATIONS** — Gallery stub; Limitations below. Live old-path samples not yet pasted.

- **Display name:** Solving equations with the Quadratic Formula
...
- **Skill:** Solving equations with the Quadratic Formula (catalog: `quadratic_formula`).
...
|------|-----|-------------------------------------------|
| OpenStax Intermediate Algebra 2e §9.3 | https://openstax.org/books/intermediate-algebra-2e/pages/9-3-solve-quadratic-equations-using-the-quadratic-formula | Quadratic formula |
