# Notes — `pc_evaluating_logarithms` (`Evaluating logarithms`)
...
- **Skill:** Student evaluate for evaluating logarithms.
- **D=0:** evaluate log at nice value; simplest numeric/instance (per OpenStax § easy exercises).
...
| 8 | 101 | `$\log_{5}\left(125\right)$` | `$3$` | evaluate/rewrite |
| 16 | 101 | `$\log_{9}\left(9\right)$` | `$1$` | evaluate/rewrite |
| 22 | 101 | `$\log_{6}\left(1585\right)$` | `$4.11$` | evaluate/rewrite |
...
|------|-----|-------------------------------------------|
| OpenStax Precalculus 2e §4.3 | https://openstax.org/books/precalculus-2e/pages/4-3-logarithmic-functions | evaluate log at nice value |
