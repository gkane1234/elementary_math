...
CATALOG: tuple[TypeCatalogEntry, ...] = (
    ...
    _g6(
        ...
        generator="g6_integer_add_subtract",
    ...
    # Equations
    _g6("Equations", "g6_solutions_to_equations", "Solutions to equations", generator="one_step_equations", instruction_text="Determine if the value is a solution."),
    ...
    _g6(
        ...
        "Constant rate equations", generator="two_step_equations", instruction_text="Write the equation.",
    ),
    _g6(
        "Equations as Relationships between Two Variables",
        "g6_equations_for_other_relationships",
        "Equations for other relationships", generator="multi_step_equations", instruction_text="Write the equation.",
    ),
    # Polygons
    _g6(
        "Polygons",
