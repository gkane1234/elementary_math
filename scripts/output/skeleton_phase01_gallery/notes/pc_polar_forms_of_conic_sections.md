# Notes — `pc_polar_forms_of_conic_sections` (`Polar forms of conic sections`)
...
- **Skill:** Student identify or write the equation for polar forms of conic sections.
- **D=0:** r = ed/(1±e cos θ) identify e; simplest numeric/instance (per OpenStax § easy exercises).
...
|---|------|--------------|--------------|-------------|
| 0 | 101 | `$r=\frac{9}{2-3\sin\theta}$` | `$\text{hyperbola }, e=\frac{3}{2}$` | evaluate/rewrite |
| 8 | 101 | `$r=\frac{9}{2-3\sin\theta}$` | `$\text{hyperbola }, e=\frac{3}{2}$` | evaluate/rewrite |
| 16 | 101 | `$r=\frac{9}{2-3\sin\theta}$` | `$\text{hyperbola }, e=\frac{3}{2}$` | evaluate/rewrite |
| 22 | 101 | `$r=\frac{9}{2-3\sin\theta}$` | `$\text{hyperbola }, e=\frac{3}{2}$` | evaluate/rewrite |
...
|------|-----|-------------------------------------------|
| OpenStax Precalculus 2e §10.5 | https://openstax.org/books/precalculus-2e/pages/10-5-conic-sections-in-polar-coordinates | r = ed/(1±e cos θ) identify e |

Local HTML (if mined): `textbooks/openstax/html/precalculus-2e/…` or `scripts/output/example_mining/precalculus-2e/stage1/10-5-conic-sections-in-polar-coordinates.md`
...
- **Reuse:** Polar conic parameter skeleton.
...
- **Variety:** Old-path table shows one prompt shape across D bands sampled (seed=101) — `$r=\frac{9}{2-3\sin\theta}$`.
