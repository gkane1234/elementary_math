# Notes — `pc_area_and_laws_of_sines_and_cosines` (`Area and Laws of Sines and Cosines`)
...
- **Skill:** Student find the area or missing measure for area and laws of sines and cosines.
- **D=0:** area = ½ab sin C or Heron; simplest numeric/instance (per OpenStax § easy exercises).
...
|---|------|--------------|--------------|-------------|
| 0 | 101 | `$\text{In } \triangle ABC,\ m\angle A = 45^\circ,\ m\angle B = 45^\circ,\ a = 8.\ \text{Find } b \text{ (Law of Sines).}$` | `$8.00$` | triangle |
| 8 | 101 | `$\text{In } \triangle ABC,\ m\angle A = 30^\circ,\ m\angle B = 70^\circ,\ a = 18.\ \text{Find } b \text{ (Law of Sines).}$` | `$33.83$` | triangle |
| 16 | 101 | `$\text{In } \triangle ABC,\ m\angle A = 70^\circ,\ m\angle B = 60^\circ,\ a = 17.\ \text{Find } b \text{ (Law of Sines).}$` | `$15.67$` | triangle |
| 22 | 101 | `$\text{In } \triangle ABC,\ m\angle A = 80^\circ,\ m\angle B = 50^\circ,\ a = 18.\ \text{Find } b \text{ (Law of Sines).}$` | `$14.00$` | triangle |
...
|------|-----|-------------------------------------------|
| OpenStax Precalculus 2e §8.2 | https://openstax.org/books/precalculus-2e/pages/8-2-non-right-triangles-law-of-cosines | area = ½ab sin C or Heron |
