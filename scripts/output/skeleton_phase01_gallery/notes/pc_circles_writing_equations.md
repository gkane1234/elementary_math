# Notes — `pc_circles_writing_equations` (`Circles, writing equations`)
...
- **Skill:** Student write the equation of the circle for circles, writing equations.
- **D=0:** write circle from center/radius; simplest numeric/instance (per OpenStax § easy exercises).
...
|---|------|--------------|--------------|-------------|
| 0 | 101 | `$\text{Write the equation of the circle with center }(0,0)\text{ and radius }4.$` | `$x^2+y^2=16$` | evaluate/rewrite |
| 8 | 101 | `$\text{Write the equation of the circle with center }(1,3)\text{ and radius }3.$` | `$(x-(1))^2+(y-(3))^2=9$` | evaluate/rewrite |
| 16 | 101 | `$\text{Write the equation of the circle with center }(4,-2)\text{ and radius }6.$` | `$(x-(4))^2+(y-(-2))^2=36$` | evaluate/rewrite |
| 22 | 101 | `$\text{Write the equation of the circle with center }(3,-3)\text{ and radius }7.$` | `$(x-(3))^2+(y-(-3))^2=49$` | evaluate/rewrite |
...
|------|-----|-------------------------------------------|
| OpenStax Precalculus 2e §10.1 | https://openstax.org/books/precalculus-2e/pages/10-1-the-circle | write circle from center/radius |

Local HTML (if mined): `textbooks/openstax/html/precalculus-2e/…` or `scripts/output/example_mining/precalculus-2e/stage1/10-1-the-circle.md`
