# Notes — `a2_exponential_and_logarithmic_expressions_logarithms_and_exponents_as_inverses`

> **LOW_VARIETY** — One template across seeds at D=0.

- **Display name:** Logarithms and exponents as inverses
...
- **Skill:** Practice logarithms and exponents as inverses (catalog: log_evaluate).
...
|---|------|--------------|--------------|-------------|
| 0 | 101 | $\log_{2}\left(8\right)$ | $3$ | — |
| 0 | 207 | $\log_{5}\left(125\right)$ | $3$ | — |
| 8 | 101 | $\log_{7}\left(343\right)$ | $3$ | — |
| 8 | 207 | $\log_{7}\left(2401\right)$ | $4$ | — |
| 16 | 101 | $\ln\left(20.0855\right)$ | $3$ | — |
| 16 | 207 | $\log\left(1000000\right)$ | $6$ | — |
| 22 | 101 | $\log_{5}\left(1872\right)$ | $4.68$ | — |
| 22 | 207 | $\log_{5}\left(4195\right)$ | $5.18$ | — |
...
- **Reuse:** Existing `log_evaluate` hand path until a skeleton exists.
- **New:** only if no honest match — leave leaf and document skip.
- **Not this pass:** notes only; no generator implementation.

_Catalog generator `log_evaluate`; equations/WP agent owns solve/WP siblings._
