# Notes — `a2_exponential_and_logarithmic_expressions_evaluating_logarithms`

> **LOW_VARIETY** — One template across seeds at D=0.

- **Display name:** Evaluating logarithms
...
- **Skill:** Practice evaluating logarithms (catalog: log_evaluate).
...
| 0 | 207 | $\log_{2}\left(32\right)$ | $5$ | — |
| 8 | 101 | $\log_{4}\left(4096\right)$ | $6$ | — |
| 8 | 207 | $\log_{3}\left(27\right)$ | $3$ | — |
| 16 | 101 | $\ln\left(403.4288\right)$ | $6$ | — |
| 16 | 207 | $\log_{6}\left(1296\right)$ | $4$ | — |
| 22 | 101 | $\log_{12}\left(1042\right)$ | $2.8$ | — |
| 22 | 207 | $\log_{8}\left(2393\right)$ | $3.74$ | — |
