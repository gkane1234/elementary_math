# Notes — `pc_binomial_theorem` (`The Binomial Theorem`)
...
- **Skill:** Student expand using the binomial theorem for the binomial theorem.
- **D=0:** expand (a+b)^n; simplest numeric/instance (per OpenStax § easy exercises).
...
|---|------|--------------|--------------|-------------|
| 0 | 101 | `$\text{Find the coefficient of } x^{1} \text{ in } (2 + x)^{4}.$` | `$32$` | evaluate/rewrite |
| 8 | 101 | `$\text{Find the coefficient of } x^{1} \text{ in } (1 + x)^{4}.$` | `$4$` | evaluate/rewrite |
| 16 | 101 | `$\text{Find the coefficient of } x^{3} \text{ in } (4 + x)^{5}.$` | `$160$` | evaluate/rewrite |
| 22 | 101 | `$\text{Find the coefficient of } x^{3} \text{ in } (4 + x)^{5}.$` | `$160$` | evaluate/rewrite |
...
|------|-----|-------------------------------------------|
| OpenStax Precalculus 2e §11.4 | https://openstax.org/books/precalculus-2e/pages/11-4-the-binomial-theorem | expand (a+b)^n |

Local HTML (if mined): `textbooks/openstax/html/precalculus-2e/…` or `scripts/output/example_mining/precalculus-2e/stage1/11-4-the-binomial-theorem.md`
...
- **Reuse:** Binomial expand constructive.
