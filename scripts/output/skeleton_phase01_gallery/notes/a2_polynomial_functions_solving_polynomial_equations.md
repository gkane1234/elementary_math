# Notes — `a2_polynomial_functions_solving_polynomial_equations`

> **LIMITATIONS** — Gallery stub; Limitations below. Live old-path samples not yet pasted.

- **Display name:** Solving polynomial equations
...
- **Skill:** Solving polynomial equations (catalog: `quadratic_factoring_equations`).
...
|------|-----|-------------------------------------------|
| OpenStax Intermediate Algebra 2e §6.5 / §9.5 | https://openstax.org/books/intermediate-algebra-2e/pages/6-5-general-strategy-for-factoring-polynomials | Factor polynomial equations (may alias quadratic factor-to-solve) |
