...
WIRING: list[tuple[str, str, str, str]] = [
    ...
    ("calc_diff_average_rates_of_change", "average_rate_of_change", "calculus", "differentiation"),
    ("calc_diff_definition_of_the_derivative", "definition_of_derivative", "calculus", "differentiation"),
    ("calc_diff_higher_order_derivatives", "derivative_higher_order", "calculus", "differentiation"),
    ("calc_diff_product_rule", "derivative_product_rule", "calculus", "differentiation"),
    ("calc_diff_quotient_rule", "derivative_quotient_rule", "calculus", "differentiation"),
    ("calc_diff_chain_rule", "derivative_chain_rule", "calculus", "differentiation"),
    ("calc_diff_trigonometric", "derivative_trigonometric", "calculus", "differentiation"),
    ("calc_diff_implicit", "derivative_implicit", "calculus", "differentiation"),
    ("calc_indef_int_power_rule_with_substitution", "integral_substitution", "calculus", "indefinite_integration"),
    ("calc_indef_int_trigonometric", "integral_trigonometric", "calculus", "indefinite_integration"),
    ("calc_def_int_approximating_area_under_a_curve", "riemann_approximate_area", "calculus", "definite_integration"),
    ("calc_def_int_first_fundamental_theorem_of_calculus", "first_fundamental_theorem", "calculus", "definite_integration"),
    ("calc_app_int_area_under_a_curve", "area_under_curve", "calculus", "applications_of_integration"),
