...
CATALOG: tuple[TypeCatalogEntry, ...] = (
    ...
    _pa(
        ...
        "Naming decimal places and rounding", generator="pa_naming_decimal_places_and_rounding", instruction_text="Name the place value or round.",
    ),
    _pa(
        "Integers, Decimals, and Fractions",
        "pa_writing_numbers_with_words",
        "Writing numbers with words",
        generator="pa_writing_numbers_with_words",
    ...
    _pa(
        ...
        "Multiplying", generator="pa_integers_multiplying", instruction_text="Multiply.",
    ),
    _pa(
        "Integers, Decimals, and Fractions",
        "pa_integers_dividing",
        "Dividing", generator="pa_integers_dividing", instruction_text="Divide.",
    ),
    _pa(
        "Integers, Decimals, and Fractions",
        "pa_factoring",
        "Factoring",
        generator="pa_factoring",
        instruction_text="Factor.",
    ),
    _pa(
        "Integers, Decimals, and Fractions",
        "pa_greatest_common_factor",
        "Greatest common factor", generator="pa_greatest_common_factor", instruction_text="Find the GCF.",
    ),
    _pa(
        "Integers, Decimals, and Fractions",
        "pa_least_common_multiple",
        "Least common multiple", generator="pa_least_common_multiple", instruction_text="Find the LCM.",
    ),
    _pa(
        "Integers, Decimals, and Fractions",
        "pa_simplifying_fractions",
        "Simplifying fractions", generator="pa_simplifying_fractions", instruction_text="Simplify.",
    ),
    # OpenStax Prealgebra 2e §4.2 / 4.4 / 4.5 — thin aliases onto existing G6 fraction generators.
    _pa(
        "Integers, Decimals, and Fractions",
        "pa_fractions_add_like",
        "Adding fractions (like denominators)",
        generator="pa_fractions_add_like",
    ...
    _pa(
        ...
        generator="pa_fractions_subtract_like",
    ...
    _pa(
        ...
        generator="pa_fractions_add_unlike",
        instruction_text="Add.",
    ),
    _pa(
        "Integers, Decimals, and Fractions",
        ...
        generator="pa_fractions_subtract_unlike",
        instruction_text="Subtract.",
    ),
    _pa(
        "Integers, Decimals, and Fractions",
        ...
        generator="pa_fractions_multiply",
    ...
    _pa(
        ...
        generator="pa_converting_fractions_and_decimals",
    ...
    _pa(
        "Factors and Exponents",
        "pa_divisibility",
        "Divisibility", generator="pa_divisibility", instruction_text="Determine if the number is divisible.",
    ),
    _pa(
        "Factors and Exponents",
    ...
    _pa(
        ...
        generator="pa_fractions_decimals_and_percents",
    ...
    _pa(
        ...
        generator="pa_drawing_and_measuring_angles", instruction_text="Measure or draw the angle.",
    ),
    _pa(
        "Plane Figures",
        "pa_angle_relationships",
        "Angle relationships",
        generator="pa_angle_relationships", instruction_text="Find the angle measure.",
    ),
    _pa(
        "Plane Figures",
        "pa_plane_figures_triangles",
        "Triangles",
        generator="pa_plane_figures_triangles", instruction_text="Find the measure.",
    ),
    _pa(
        "Plane Figures",
        "pa_quadrilaterals",
        "Quadrilaterals",
        generator="pa_quadrilaterals", instruction_text="Find the measure.",
    ),
    _pa(
        "Plane Figures",
        "pa_area_of_triangles_and_quadrilaterals",
        "Area of triangles and quadrilaterals",
        generator="pa_area_of_triangles_and_quadrilaterals",
    ...
    _pa(
        ...
        "pa_circles",
        "Circles",
        generator="pa_circles", instruction_text="Find the measure.",
    ),
    _pa(
        "Plane Figures",
        "pa_transformations",
        "Transformations",
        generator="pa_transformations",
    ...
    _pa(
        ...
        generator="pa_classifying_volume_and_surface_area", instruction_text="Find the volume or surface area.",
    ),
    # Right Triangles
    _pa(
        "Right Triangles",
        "pythagorean_theorem",
        "The Pythagorean Theorem", generator="pa_pythagorean_theorem", instruction_latex="\\text{Find the missing side.}",
