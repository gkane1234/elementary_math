# Notes — `a2_polynomial_functions_end_behavior_and_general_graph_shape`

> **UNCLEAR / NOT_IMPLEMENTED** — see Limitations.


- **Display name:** End behavior and general graph shape
...
- **Skill:** Practice end behavior and general graph shape (catalog: polynomial_end_behavior).
...
|---|------|--------------|--------------|-------------|
| 0 | 101 | $\text{Describe the end behavior of } f(x)=3x^{3} - 2x^{2}.$ | $x\to-\infty:f(x)\to-\infty;\quad x\to\infty:f(x)\to\infty$ | — |
| 0 | 207 | $\text{Describe the end behavior of } f(x)=3x^{3} + 2x^{2} + 2.$ | $x\to-\infty:f(x)\to-\infty;\quad x\to\infty:f(x)\to\infty$ | — |
| 8 | 101 | $\text{Describe the end behavior of } f(x)=-5x^{4} - 3x^{2} - 3.$ | $\text{as }x\to\pm\infty,\ f(x)\to-\infty$ | — |
| 8 | 207 | $\text{Describe the end behavior of } f(x)=5x^{4} + 2x^{2} - 3.$ | $\text{as }x\to\pm\infty,\ f(x)\to\infty$ | — |
| 16 | 101 | $\text{Describe the end behavior of } f(x)=-7x^{4} - 3x^{2} - 3.$ | $\text{as }x\to\pm\infty,\ f(x)\to-\infty$ | — |
| 16 | 207 | $\text{Describe the end behavior of } f(x)=3x^{5} - 3x^{2} - 1.$ | $x\to-\infty:f(x)\to-\infty;\quad x\to\infty:f(x)\to\infty$ | — |
| 22 | 101 | $\text{Describe the end behavior of } f(x)=5x^{5} - 8x^{2} - 5.$ | $x\to-\infty:f(x)\to-\infty;\quad x\to\infty:f(x)\to\infty$ | — |
| 22 | 207 | $\text{Describe the end behavior of } f(x)=-9x^{4} - x^{2} - 4.$ | $\text{as }x\to\pm\infty,\ f(x)\to-\infty$ | — |
...
- **Reuse:** Existing `polynomial_end_behavior` hand path until a skeleton exists.
- **New:** only if no honest match — leave leaf and document skip.
- **Not this pass:** notes only; no generator implementation.

_Catalog generator `polynomial_end_behavior`; equations/WP agent owns solve/WP siblings._
