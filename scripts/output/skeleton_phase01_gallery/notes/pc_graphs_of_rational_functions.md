# Notes — `pc_graphs_of_rational_functions` (`Graphs of rational functions`)
...
- **Skill:** Student graph the following functions for graphs of rational functions.
- **D=0:** graph rational with asymptotes; simplest numeric/instance (per OpenStax § easy exercises).
...
|---|------|--------------|--------------|-------------|
| 0 | 101 | `$y = \frac{1}{x + 2}$` | `$y = \frac{1}{x + 2}$` | evaluate/rewrite |
| 8 | 101 | `$y = \frac{3}{x}$` | `$y = \frac{3}{x}$` | evaluate/rewrite |
| 16 | 101 | `$y = \frac{2}{x}$` | `$y = \frac{2}{x}$` | evaluate/rewrite |
| 22 | 101 | `$y = \frac{2}{x}$` | `$y = \frac{2}{x}$` | evaluate/rewrite |
...
|------|-----|-------------------------------------------|
| OpenStax Precalculus 2e §3.7 | https://openstax.org/books/precalculus-2e/pages/3-7-rational-functions | graph rational with asymptotes |
...
- **Reuse:** Graph framework (asymptote metadata); not expr skeleton.
