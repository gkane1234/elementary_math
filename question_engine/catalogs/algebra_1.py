...
CATALOG: tuple = (
    ...
    entry(
        ...
        instruction_latex=r"\text{Simplify.}",
        instruction_text="Simplify.",
        description="Combine like terms / undo distribute clutter to standard form.",
    ),
    entry(
        "polynomial_multiply",
        "Multiplying",
    ...
    entry(
        ...
        instruction_latex=r"\text{Factor.}",
        instruction_text="Factor.",
        description="Factors-first quadratic trinomials; unsimplified stems at high D.",
    ),
    entry(
        ...
        instruction_latex=r"\text{Factor completely.}",
        instruction_text="Factor completely.",
        description="Choose method / factor completely — mixes GCF, quadratic, special, grouping.",
    ),
    entry(
