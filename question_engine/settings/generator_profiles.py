...
from .domains.common import continuous_difficulty_settings
...
_RAW_GENERATOR_SETTING_CONFIGS: dict[str, TypeSettingConfig] = {    # Equations
    ...
    # PA catalog aliases that share G6 / family generators (explicit type_id rows).
    "pa_integers_multiplying": TypeSettingConfig(setting_profile="integer"),
    "pa_integers_dividing": TypeSettingConfig(setting_profile="integer"),
    "pa_factoring": TypeSettingConfig(setting_profile="factor"),
    "pa_greatest_common_factor": TypeSettingConfig(
        setting_profile="factor",
        extra_settings=(gcf_constraint_settings,),
        setting_defaults={"require_gcf_greater_than_one": True},
    ),
    "pa_least_common_multiple": TypeSettingConfig(setting_profile="factor"),
    "pa_simplifying_fractions": TypeSettingConfig(setting_profile="rational"),
    "pa_fractions_add_like": TypeSettingConfig(setting_profile="rational"),
    "pa_fractions_subtract_like": TypeSettingConfig(setting_profile="rational"),
    "pa_fractions_add_unlike": TypeSettingConfig(setting_profile="rational"),
    "pa_fractions_subtract_unlike": TypeSettingConfig(setting_profile="rational"),
    "pa_fractions_multiply": TypeSettingConfig(setting_profile="rational"),
    "pa_fractions_divide": TypeSettingConfig(setting_profile="rational"),
    "pa_converting_fractions_and_decimals": TypeSettingConfig(
        setting_profile="rational",
        inherits=("decimal",),
    ),
    "pa_naming_decimal_places_and_rounding": TypeSettingConfig(setting_profile="decimal"),
    "pa_writing_numbers_with_words": TypeSettingConfig(setting_profile="integer"),
    "pa_divisibility": TypeSettingConfig(setting_profile="factor"),
    ...
    "g6_part_part_whole_ratios": TypeSettingConfig(setting_profile="ratio"),
    "g6_comparing_ratios": TypeSettingConfig(setting_profile="ratio"),
    ...
    "g6_decimal_multiplication_with_equivalent_fractions": TypeSettingConfig(
        setting_profile="decimal",
        extra_settings=(decimal_multiplication_settings,),
        setting_defaults={"decimal_multiply_via_fractions": True},
    ),
    ...
    # Diagram / placeholder scaffolds still expose continuous difficulty.
    "scaffold": TypeSettingConfig(
        extra_settings=(continuous_difficulty_settings,),
        setting_defaults={"difficulty": 6},
        exclude_settings=_excludes(_TERM_SETTINGS, _PHRASE_SETTINGS),
    ),
    # Exponential / misc
    ...
    "limit_removable": TypeSettingConfig(
        setting_profile="limits",
        setting_defaults={
    ...
    "limit_essential": TypeSettingConfig(
        setting_profile="limits",
        setting_defaults={
    ...
    "limit_continuity": TypeSettingConfig(
        setting_profile="limits",
        setting_defaults={
            "allow_removable": True,
            "allow_piecewise": True,
    ...
    "integral_trigonometric": TypeSettingConfig(
        setting_profile="integrals",
        setting_defaults={
            "allow_trig": True,
            "require_trig": True,
    ...
    "integral_log_exp": TypeSettingConfig(
        setting_profile="integrals",
        setting_defaults={
            "allow_exp": True,
            "allow_log": True,
    ...
    "integral_inverse_trig": TypeSettingConfig(
        setting_profile="integrals",
        setting_defaults={
            "allow_invtrig": True,
            "include_plus_c": True,
    ...
    "integral_substitution": TypeSettingConfig(
        setting_profile="integrals",
        setting_defaults={
            "allow_substitution": True,
    ...
    "integral_definite_substitution": TypeSettingConfig(
        setting_profile="integrals",
        setting_defaults={
            "allow_substitution": True,
            "require_substitution": True,
    ...
    "integral_trig_substitution": TypeSettingConfig(
        setting_profile="integrals",
        setting_defaults={
            "allow_trig": True,
            "allow_trig_sub": True,
    ...
    "integral_invtrig_substitution": TypeSettingConfig(
        setting_profile="integrals",
        setting_defaults={
            "allow_invtrig": True,
            "allow_substitution": True,
    ...
    "integration_by_parts": TypeSettingConfig(
        setting_profile="integrals",
        setting_defaults={
            "allow_parts": True,
            "require_parts": True,
    ...
    "integral_partial_fractions": TypeSettingConfig(
        setting_profile="integrals",
        setting_defaults={
            "allow_pfd": True,
            "require_pfd": True,
    ...
    "integral_multi_trick": TypeSettingConfig(
        setting_profile="integrals",
        setting_defaults={
            "allow_substitution": True,
            "allow_pfd": True,
    ...
    "integral_general": TypeSettingConfig(
        setting_profile="integrals",
        setting_defaults={
            "allow_trig": True,
            "allow_exp": True,
    ...
    "first_fundamental_theorem": TypeSettingConfig(
        setting_profile="integrals",
        setting_defaults={
            "allow_ftc": True,
            "definite": True,
    ...
    "second_fundamental_theorem": TypeSettingConfig(
        setting_profile="integrals",
        setting_defaults={
            "allow_ftc": True,
            "allow_substitution": True,
    ...
    "linear_approximation": TypeSettingConfig(setting_profile="derivatives"),
    "derivative_product_rule": TypeSettingConfig(
        setting_profile="derivatives",
        setting_defaults={
            # Algebraic leaf: specials OFF; checkbox opt-in → available from D=0.
            "allow_trig": False,
            "allow_exp": False,
            "allow_log": False,
            "allow_hyperbolic": False,
    ...
    "derivative_quotient_rule": TypeSettingConfig(
        setting_profile="derivatives",
        setting_defaults={
            # Algebraic leaf: specials OFF; checkbox opt-in → available from D=0.
            "allow_trig": False,
    ...
    "derivative_chain_rule": TypeSettingConfig(
        setting_profile="derivatives",
        setting_defaults={
            # OpenStax §3.6: specials ON; D-unlocks keep D=0 as (ax+b)^n.
            "allow_trig": True,
            "allow_exp": True,
            "allow_log": True,
            "allow_hyperbolic": False,
    ...
    "derivative_general": TypeSettingConfig(
        setting_profile="derivatives",
        setting_defaults={
            # Fully tunable: checkboxes default ON → available from D=0.
            "allow_trig": True,
            "allow_exp": True,
            "allow_log": True,
    ...
    "derivative_trigonometric": TypeSettingConfig(
        setting_profile="derivatives",
        setting_defaults={
            "allow_trig": True,
            "allow_exp": False,
    ...
    "derivative_implicit": TypeSettingConfig(
        setting_profile="derivatives",
        setting_defaults={
            "allow_trig": False,
            "allow_exp": False,
    ...
    "derivative_higher_order": TypeSettingConfig(
        setting_profile="derivatives",
        setting_defaults={
            # Soft-unlock trig/exp; Spec path forces derivative_order ≥ 2.
            "allow_trig": True,
            "allow_exp": True,
            "allow_log": False,
            "allow_hyperbolic": False,
    ...
    "vector_diagrams": TypeSettingConfig(setting_profile="coordinate_plane"),
    ...
    "derivative_ln_exp": TypeSettingConfig(
        setting_profile="derivatives",
        setting_defaults={
            "allow_trig": False,
            "allow_exp": True,
    ...
    "intervals_concavity": TypeSettingConfig(setting_profile="derivatives"),
    "relative_extrema": TypeSettingConfig(setting_profile="derivatives"),
    "absolute_extrema": TypeSettingConfig(setting_profile="derivatives"),
    "optimization_applied": TypeSettingConfig(setting_profile="derivatives"),
    "curve_sketching": TypeSettingConfig(setting_profile="derivatives"),
    "graphical_f_fp": TypeSettingConfig(setting_profile="derivatives"),
    "newtons_method": TypeSettingConfig(setting_profile="derivatives"),
    "motion_along_a_line": TypeSettingConfig(setting_profile="derivatives"),
    "motion_along_a_line_integral": TypeSettingConfig(setting_profile="integrals"),
    "de_introduction": TypeSettingConfig(setting_profile="derivatives"),
    ...
    "vector_3d_operations": TypeSettingConfig(setting_profile="algebra_expression"),
    "cross_products": TypeSettingConfig(setting_profile="algebra_expression"),
    "pc_continuity": TypeSettingConfig(setting_profile="algebra_expression"),
    "pc_extrema_intervals": TypeSettingConfig(setting_profile="algebra_expression"),
    "pc_power_functions": TypeSettingConfig(setting_profile="algebra_expression"),
    "pc_piecewise_functions": TypeSettingConfig(setting_profile="algebra_expression"),
    "pc_complex_zeros": TypeSettingConfig(setting_profile="polynomial"),
    "pc_polynomial_inequalities": TypeSettingConfig(setting_profile="algebra_expression"),
    "pc_rational_inequalities": TypeSettingConfig(setting_profile="algebra_expression"),
    "pc_angles_and_angle_measure": TypeSettingConfig(setting_profile="trigonometry"),
    "pc_parametric_equations": TypeSettingConfig(setting_profile="algebra_expression"),
    "pc_projectile_motion": TypeSettingConfig(setting_profile="word_problem"),
    "pc_3d_points": TypeSettingConfig(setting_profile="algebra_expression"),
    "pc_multivariable_systems": TypeSettingConfig(setting_profile="algebra_expression"),
    "pc_mathematical_induction": TypeSettingConfig(setting_profile="algebra_expression"),
    "pc_power_series": TypeSettingConfig(setting_profile="algebra_expression"),
    "pc_motion_along_a_line": TypeSettingConfig(setting_profile="derivatives"),
    ...
    "derivative_logarithmic": TypeSettingConfig(
        setting_profile="derivatives",
        setting_defaults={
            "allow_trig": False,
            "allow_exp": True,
    ...
    "derivative_inverse_trig": TypeSettingConfig(
        setting_profile="derivatives",
        setting_defaults={
            "allow_trig": False,
            "allow_exp": False,
    ...
    "derivative_other_base": TypeSettingConfig(
        setting_profile="derivatives",
        setting_defaults={
            "allow_trig": False,
            "allow_exp": True,
    ...
    "calc_continuous_growth_decay": TypeSettingConfig(setting_profile="derivatives"),
    ...
    "g6_classifying_and_naming": TypeSettingConfig(setting_profile="geometry_basic"),
    ...
    "g6_rectangles_with_fraction_side_lengths": TypeSettingConfig(
        setting_profile="geometry_basic"
    ),
    "g6_triangles_with_fraction_side_lengths": TypeSettingConfig(
        setting_profile="geometry_basic"
    ),
    "g6_polygon_grid_area": TypeSettingConfig(setting_profile="geometry_basic"),
    "g6_polygons_on_a_grid_or_coordinate_plane": TypeSettingConfig(
        setting_profile="geometry_basic"
    ),
    "g6_shaded_polygon_area": TypeSettingConfig(setting_profile="geometry_basic"),
    "g6_polygons_and_shaded_regions": TypeSettingConfig(setting_profile="geometry_basic"),
    "g6_isometric_measure": TypeSettingConfig(setting_profile="geometry_basic"),
    "g6_volume_and_surface_area_using_isometric_drawings": TypeSettingConfig(
        setting_profile="geometry_basic"
    ),
    "g6_formulas_for_volume_and_surface_area_of_a_cube": TypeSettingConfig(
        setting_profile="geometry_basic",
        setting_defaults={"solid_shapes": ["cube"]},
    ),
    "g6_triangles": TypeSettingConfig(
        setting_profile="geometry_triangles",
        exclude_settings=(
            "allow_acute",
            "allow_right",
    ...
    "g6_trapezoids": TypeSettingConfig(setting_profile="geometry_basic"),
    "g6_kites": TypeSettingConfig(setting_profile="geometry_basic"),
