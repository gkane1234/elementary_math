# Notes — `pc_circles_graphing_and_properties` (`Circles, graphing and properties`)
...
- **Skill:** Student graph the circle for circles, graphing and properties.
- **D=0:** graph circle center-radius; simplest numeric/instance (per OpenStax § easy exercises).
...
|---|------|--------------|--------------|-------------|
| 0 | 101 | `$x^2+y^2=16$` | `$\text{center }(0,0),\ \text{radius }4$` | evaluate/rewrite |
| 8 | 101 | `$(x-(1))^2+(y-(3))^2=9$` | `$\text{center }(1,3),\ \text{radius }3$` | evaluate/rewrite |
| 16 | 101 | `$(x-(4))^2+(y-(-2))^2=36$` | `$\text{center }(4,-2),\ \text{radius }6$` | evaluate/rewrite |
| 22 | 101 | `$(x-(3))^2+(y-(-3))^2=49$` | `$\text{center }(3,-3),\ \text{radius }7$` | evaluate/rewrite |
...
|------|-----|-------------------------------------------|
| OpenStax Precalculus 2e §10.1 | https://openstax.org/books/precalculus-2e/pages/10-1-the-circle | graph circle center-radius |
