# Notes — `a2_quadratic_functions_and_inequalities_solving_equations_by_factoring`

> **LIMITATIONS** — Gallery stub; Limitations below. Live old-path samples not yet pasted.

- **Display name:** Solving equations by factoring
...
- **Skill:** Solving equations by factoring (catalog: `quadratic_factoring_equations`).
...
|------|-----|-------------------------------------------|
| OpenStax Intermediate Algebra 2e §6.5 | https://openstax.org/books/intermediate-algebra-2e/pages/6-5-general-strategy-for-factoring-polynomials | Factor then zero-product |
