...
Live default is OpenStax EA §5.4 number / tickets / geometry / motion. Old dump is `use_legacy_systems=True`.
...
**Shipped:** SystemsWP frames on the systems core. Do not keep the dump stub as live default.
