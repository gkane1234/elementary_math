# Notes — `pc_parabolas_writing_equations` (`Parabolas, writing equations`)
...
- **Skill:** Student write the equation of the parabola for parabolas, writing equations.
- **D=0:** write eqn from focus/directrix; simplest numeric/instance (per OpenStax § easy exercises).
...
|---|------|--------------|--------------|-------------|
| 0 | 101 | `$\text{Write the equation of a parabola with vertex }(0,0)\text{ and focus }(0,3).$` | `$x^2=12y$` | evaluate/rewrite |
| 8 | 101 | `$\text{Write the equation of a parabola with vertex }(0,0)\text{ and focus }(2,0).$` | `$y^2=8x$` | evaluate/rewrite |
| 16 | 101 | `$\text{Write the equation of a parabola with vertex }(0,0)\text{ and focus }(0,5).$` | `$x^2=20y$` | evaluate/rewrite |
| 22 | 101 | `$\text{Write the equation of a parabola with vertex }(0,0)\text{ and focus }(0,5).$` | `$x^2=20y$` | evaluate/rewrite |
...
|------|-----|-------------------------------------------|
| OpenStax Precalculus 2e §10.2 | https://openstax.org/books/precalculus-2e/pages/10-2-the-parabola | write eqn from focus/directrix |
