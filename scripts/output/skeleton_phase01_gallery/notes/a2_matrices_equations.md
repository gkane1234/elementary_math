...
- **Skill:** Equations (catalog: `matrix_operations`).
...
|------|-----|-------------------------------------------|
| OpenStax Intermediate Algebra 2e §4.6 | https://openstax.org/books/intermediate-algebra-2e/pages/4-6-solve-systems-of-equations-using-matrices | Matrix equations AX=B — gold vs ops leaf still separate |
