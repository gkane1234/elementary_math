# Notes — `a2_trigonometry_equations`
...
- **Skill:** Equations (catalog: `simple_trig_equations`).
...
|------|-----|-------------------------------------------|
| OpenStax College Algebra 2e §8.1 / Precalculus §7 | https://openstax.org/books/college-algebra-2e/pages/8-1-graphs-of-the-sine-and-cosine-functions | Simple trig equations — variety/OpenStax lock TBD |
