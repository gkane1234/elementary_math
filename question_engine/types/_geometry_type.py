"""Register geometry-framework catalog types with inherited setting profiles."""
...
def register_geometry_type(
    ...
    *,
    profile: str = "geometry_basic",
    inherits: tuple[str, ...] = (),
    exclude_settings: tuple[str, ...] = (),
    setting_defaults: dict[str, Any] | None = None,
) -> type:
    """Wire a catalog geometry type to ``register_framework_type`` + profile inheritance."""
