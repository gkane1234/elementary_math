# Notes — `pc_probability_independent_dependent_events` (`Probability: Independent/dependent events`)
...
- **Skill:** Student find the probability for probability: independent/dependent events.
- **D=0:** P(A and B) independent; simplest numeric/instance (per OpenStax § easy exercises).
...
|------|-----|-------------------------------------------|
| OpenStax Precalculus 2e §11.2 | https://openstax.org/books/precalculus-2e/pages/11-2-introducing-probability | P(A and B) independent |
