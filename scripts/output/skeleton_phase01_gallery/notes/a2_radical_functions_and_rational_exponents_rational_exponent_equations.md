# Notes — `a2_radical_functions_and_rational_exponents_rational_exponent_equations`

> **LIMITATIONS** — Gallery stub; Limitations below. Live old-path samples not yet pasted.

- **Display name:** Rational exponent equations
...
- **Skill:** Rational exponent equations (catalog: `radical_equations`).
...
|------|-----|-------------------------------------------|
| OpenStax Intermediate Algebra 2e §8.6 | https://openstax.org/books/intermediate-algebra-2e/pages/8-6-solve-radical-equations | Rational-exponent equations (often shares radical_equations generator) |
