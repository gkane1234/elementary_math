# Notes — `pc_functions_operations` (`Operations`)
...
- **Skill:** Student evaluate for operations.
- **D=0:** f±g, fg, f/g at x (not composition yet); simplest numeric/instance (per OpenStax § easy exercises).
...
|---|------|--------------|--------------|-------------|
| 0 | 101 | `$\text{If } f(x) = 3x + 4 \text{ and } g(x) = 3x + 4, \text{ find } (f - g)(4).$` | `$0$` | evaluate/rewrite |
| 8 | 101 | `$\text{If } f(x) = 6x + 8 \text{ and } g(x) = 6x + 1, \text{ find } \left(\frac{f}{g}\right)(-2).$` | `$\frac{4}{11}$` | evaluate/rewrite |
| 16 | 101 | `$\text{If } f(x) = 8x + 8 \text{ and } g(x) = 8x + 1, \text{ find } (f \circ g)(-2).$` | `$-112$` | evaluate/rewrite |
| 22 | 101 | `$\text{If } f(x) = 10x + 7 \text{ and } g(x) = 10x + 6, \text{ find } \left(\frac{f}{g}\right)(8).$` | `$\frac{87}{86}$` | evaluate/rewrite |
...
|------|-----|-------------------------------------------|
| OpenStax Precalculus 2e §1.4 | https://openstax.org/books/precalculus-2e/pages/1-4-composition-of-functions | f±g, fg, f/g at x (not composition yet) |

Local HTML (if mined): `textbooks/openstax/html/precalculus-2e/…` or `scripts/output/example_mining/precalculus-2e/stage1/1-4-composition-of-functions.md`
...
- **Reuse:** Reuse `function_operations` generator + OpenStax `precalculus_function_ops.json` form catalog; add composition later.
