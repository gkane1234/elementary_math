...
ENTRIES: list[dict] = [
    ...
    {"id": "rational_expressions_equations", "name": "Equations", "category": "Algebra 1 — Rational Expressions", "instruction_latex": "\\text{Solve for } x.", "instruction_text": "Solve for x."},
    ...
    {"id": "finding_angles", "name": "Finding angles", "category": "Algebra 1 — Beginning Trigonometry", "instruction_latex": "\\text{Find the angle.}", "instruction_text": "Find the angle."},
