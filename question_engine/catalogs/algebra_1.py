...
CATALOG: tuple = (
    ...
    entry(
        ...
        instruction_latex=r"\text{Classify the number.}",
    ...
    entry(
        ...
        instruction_latex=r"\text{Graph the solution.}",
    ...
    entry(
        ...
        "Algebra 1 — Relations and Introduction to Functions",
        generator="read_intercept_from_graph",
        instruction_latex=r"\text{Evaluate the relation.}",
        instruction_text="Evaluate the relation.",
    ),
    entry(
    ...
    entry(
        ...
        "More on slope",
        "Algebra 1 — Linear Equations and Inequalities",
        generator="read_slope_from_graph",
        instruction_latex=r"\text{Find the slope.}",
        instruction_text="Find the slope.",
    ),
    entry(
    ...
    entry(
        ...
        "Algebra 1 — Beginning Trigonometry",
        generator="trig_evaluate",
        instruction_latex=r"\text{Find the angle.}",
    ...
    entry(
        ...
        "Scatter plots",
        "Pre-Algebra — Statistics",
        generator="stats_histogram_read",
    ...
    entry(
        ...
        "Pre-Algebra — Statistics",
        instruction_latex=r"\text{Use the model.}",
