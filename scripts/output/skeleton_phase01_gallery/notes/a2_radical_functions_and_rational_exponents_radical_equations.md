# Notes — `a2_radical_functions_and_rational_exponents_radical_equations`

> **LIMITATIONS** — Gallery stub; Limitations below. Live old-path samples not yet pasted.

- **Display name:** Radical equations
...
- **Skill:** Radical equations (catalog: `radical_equations`).
...
|------|-----|-------------------------------------------|
| OpenStax Intermediate Algebra 2e §8.6 | https://openstax.org/books/intermediate-algebra-2e/pages/8-6-solve-radical-equations | Isolate radical then square |
