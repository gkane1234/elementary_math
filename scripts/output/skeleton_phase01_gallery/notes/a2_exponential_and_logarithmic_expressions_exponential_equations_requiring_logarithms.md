# Notes — `a2_exponential_and_logarithmic_expressions_exponential_equations_requiring_logarithms`

> **LIMITATIONS** — Gallery stub; Limitations below. Live old-path samples not yet pasted.

- **Display name:** Exponential equations requiring logarithms
...
- **Skill:** Exponential equations requiring logarithms (catalog: `exponential_equation_with_log`).
...
|------|-----|-------------------------------------------|
| OpenStax Intermediate Algebra 2e §10.5 | https://openstax.org/books/intermediate-algebra-2e/pages/10-5-solve-exponential-and-logarithmic-equations | Take log both sides |
