# Notes — `a2_polynomial_functions_the_remainder_theorem`

- **Display name:** The Remainder Theorem
...
- **Skill:** Practice the remainder theorem (catalog: remainder_theorem).
...
|---|------|--------------|--------------|-------------|
| 0 | 101 | $\text{Find the remainder when } x^{2} + 4x - 1 \text{ is divided by } (x - 2).$ | $11$ | — |
| 0 | 207 | $\text{Find the remainder when } x^{2} - 2x - 4 \text{ is divided by } (x - 2).$ | $-4$ | — |
| 8 | 101 | $\text{Find the remainder when } x^{2} - x - 4 \text{ is divided by } (x - 2).$ | $-2$ | — |
| 8 | 207 | $\text{Find the remainder when } x^{2} - 5x - 6 \text{ is divided by } (x + 3).$ | $18$ | — |
| 16 | 101 | $\text{Find the remainder when } x^{2} - 3x - 6 \text{ is divided by } (x + 1).$ | $-2$ | — |
| 16 | 207 | $\text{Find the remainder when } x^{2} + 6x - 2 \text{ is divided by } (x + 3).$ | $-11$ | — |
| 22 | 101 | $\text{Find the remainder when } x^{2} + 7x - 6 \text{ is divided by } (x - 6).$ | $72$ | — |
| 22 | 207 | $\text{Find the remainder when } x^{2} - 7x - 9 \text{ is divided by } (x - 1).$ | $-15$ | — |
...
- **Reuse:** Existing `remainder_theorem` hand path until a skeleton exists.
- **New:** only if no honest match — leave leaf and document skip.
- **Not this pass:** notes only; no generator implementation.

_Catalog generator `remainder_theorem`; equations/WP agent owns solve/WP siblings._
