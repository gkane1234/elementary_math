# Notes — `a2_linear_relations_and_functions_graphing_linear_inequalities`

> **LOW_VARIETY / UNCLEAR / NOT_IMPLEMENTED** — One template across seeds at D=0.

- **Display name:** Graphing linear inequalities
...
- **Skill:** Practice graphing linear inequalities (catalog: graph_linear_inequality).
...
|---|------|--------------|--------------|-------------|
| 0 | 101 | $\text{Graph the inequality: } y > 2x$ | $y > 2x$ | pattern=GraphLinearIneq, figure |
| 0 | 207 | $\text{Graph the inequality: } y > 3x$ | $y > 3x$ | pattern=GraphLinearIneq, figure |
| 8 | 101 | $\text{Graph the inequality: } y > 2x$ | $y > 2x$ | pattern=GraphLinearIneq, figure |
| 8 | 207 | $\text{Graph the inequality: } y > 3x$ | $y > 3x$ | pattern=GraphLinearIneq, figure |
| 16 | 101 | $\text{Graph the inequality: } y > 2x$ | $y > 2x$ | pattern=GraphLinearIneq, figure |
| 16 | 207 | $\text{Graph the inequality: } y > 3x$ | $y > 3x$ | pattern=GraphLinearIneq, figure |
| 22 | 101 | $\text{Graph the inequality: } y > 2x$ | $y > 2x$ | pattern=GraphLinearIneq, figure |
| 22 | 207 | $\text{Graph the inequality: } y > 3x$ | $y > 3x$ | pattern=GraphLinearIneq, figure |

Opt-out flag used: `(none — live default is old path)`

## A1 alias comparison

- **A1 catalog twin:** `graph_linear_inequality` (same generator `graph_linear_inequality` unless noted).
...
- **Reuse:** Share A1 `graph_linear_inequality` generator; wire A2 catalog id when skeleton lands.
- **New:** only if no honest match — leave leaf and document skip.
- **Not this pass:** notes only; no generator implementation.

_Catalog generator `graph_linear_inequality`; equations/WP agent owns solve/WP siblings._
