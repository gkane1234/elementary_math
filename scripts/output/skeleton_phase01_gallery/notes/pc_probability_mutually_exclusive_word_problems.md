# Notes — `pc_probability_mutually_exclusive_word_problems` (`Probability: Mutually exclusive, word problems`)
...
- **Skill:** Student solve the problem for probability: mutually exclusive, word problems.
- **D=0:** P(A or B) exclusive story; simplest numeric/instance (per OpenStax § easy exercises).
...
|------|-----|-------------------------------------------|
| OpenStax Precalculus 2e §11.2 | https://openstax.org/books/precalculus-2e/pages/11-2-introducing-probability | P(A or B) exclusive story |
