# Notes — `a2_exponential_and_logarithmic_expressions_inverses_of_exponential_and_logarithmic_functions`

> **LOW_VARIETY** — One template across seeds at D=0.

- **Display name:** Inverses of exponential and logarithmic functions
- **Category:** Algebra 2 — Exponential and Logarithmic Expressions
- **Generator:** `inverse_exponential_logarithmic`
...
- **Skill:** Practice inverses of exponential and logarithmic functions (catalog: inverse_exponential_logarithmic).
...
|---|------|--------------|--------------|-------------|
| 0 | 101 | $\text{Find the inverse of } f(x)=\log_{2}(x +0) +0.$ | $f^{-1}(x)=2^{x +0} +0$ | — |
| 0 | 207 | $\text{Find the inverse of } f(x)=\log_{2}(x +0) +0.$ | $f^{-1}(x)=2^{x +0} +0$ | — |
| 8 | 101 | $\text{Find the inverse of } f(x)=\log_{2}(x -2) +0.$ | $f^{-1}(x)=2^{x +0} +2$ | — |
| 8 | 207 | $\text{Find the inverse of } f(x)=\log_{2}(x -1) -2.$ | $f^{-1}(x)=2^{x +2} +1$ | — |
| 16 | 101 | $\text{Find the inverse of } f(x)=\log_{10}(x -1) +2.$ | $f^{-1}(x)=10^{x -2} +1$ | — |
| 16 | 207 | $\text{Find the inverse of } f(x)=3^{x +4} -2.$ | $f^{-1}(x)=\log_{3}(x +2) -4$ | — |
| 22 | 101 | $\text{Find the inverse of } f(x)=5^{x -6} +2.$ | $f^{-1}(x)=\log_{5}(x -2) +6$ | — |
| 22 | 207 | $\text{Find the inverse of } f(x)=\log_{2}(x -1) +6.$ | $f^{-1}(x)=2^{x -6} +1$ | — |
...
- **Reuse:** Existing `inverse_exponential_logarithmic` hand path until a skeleton exists.
- **New:** only if no honest match — leave leaf and document skip.
- **Not this pass:** notes only; no generator implementation.

_Catalog generator `inverse_exponential_logarithmic`; equations/WP agent owns solve/WP siblings._
