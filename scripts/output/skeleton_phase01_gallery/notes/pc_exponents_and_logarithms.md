# Notes — `pc_exponents_and_logarithms` (`Exponents and logarithms`)
...
- **Skill:** Student evaluate or simplify for exponents and logarithms.
- **D=0:** rewrite between exp and log; simplest numeric/instance (per OpenStax § easy exercises).
...
|---|------|--------------|--------------|-------------|
| 0 | 101 | `$\log_{4}\left(256\right)$` | `$4$` | evaluate/rewrite |
| 8 | 101 | `$\log_{2}\left(64\right)$` | `$6$` | evaluate/rewrite |
| 16 | 101 | `$\log_{10}\left(100\right)$` | `$2$` | evaluate/rewrite |
| 22 | 101 | `$\log_{11}\left(1818\right)$` | `$3.13$` | evaluate/rewrite |
...
|------|-----|-------------------------------------------|
| OpenStax Precalculus 2e §4.3 | https://openstax.org/books/precalculus-2e/pages/4-3-logarithmic-functions | rewrite between exp and log |
