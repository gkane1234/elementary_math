# Notes — `a2_exponential_and_logarithmic_expressions_graphing_logarithmic_functions`

> **UNCLEAR / LOW_VARIETY / NOT_IMPLEMENTED** — Graph log — no algebraic skeleton; compare IA §10.3.

- **Display name:** Graphing logarithmic functions
...
- **Skill:** Practice graphing logarithmic functions (catalog: graph_logarithmic).
...
|---|------|--------------|--------------|-------------|
| 0 | 101 | $y = \log_{2}\left(x\right)$ | $y = \log_{2}\left(x\right)$ | figure |
| 0 | 207 | $y = \log_{2}\left(x\right)$ | $y = \log_{2}\left(x\right)$ | figure |
| 8 | 101 | $y = 2\log_{2}\left(x + 1\right) - 1$ | $y = 2\log_{2}\left(x + 1\right) - 1$ | figure |
| 8 | 207 | $y = \log_{2}\left(x - 1\right) + 1$ | $y = \log_{2}\left(x - 1\right) + 1$ | figure |
| 16 | 101 | $y = \log_{2}\left(x + 1\right) - 1$ | $y = \log_{2}\left(x + 1\right) - 1$ | figure |
| 16 | 207 | $y = -\log_{2}\left(x - 1\right) + 1$ | $y = -\log_{2}\left(x - 1\right) + 1$ | figure |
| 22 | 101 | $y = \log_{2}\left(x + 1\right) - 1$ | $y = \log_{2}\left(x + 1\right) - 1$ | figure |
| 22 | 207 | $y = -\log_{2}\left(x - 1\right) + 1$ | $y = -\log_{2}\left(x - 1\right) + 1$ | figure |
...
Graph log — no algebraic skeleton; compare IA §10.3.
...
- **Reuse:** Existing `graph_logarithmic` hand path until a skeleton exists.
- **New:** only if no honest match — leave leaf and document skip.
- **Not this pass:** notes only; no generator implementation.

_Catalog generator `graph_logarithmic`; equations/WP agent owns solve/WP siblings._
