...
CATALOG: tuple[TypeCatalogEntry, ...] = (
    ...
    _pc(
        ...
        "Dividing polynomial functions", generator="polynomial_long_division", instruction_latex="\\text{Divide.}",
    ...
    _pc(
        ...
        "Logarithms and exponents as inverses", generator="log_evaluate", instruction_text="Rewrite using inverses.",
    ),
    _pc(
        "Exponential and Logarithmic Expressions",
    ...
    _pc(
        ...
        "Logarithmic equations, hard", generator="log_equation_simple", instruction_latex="\\text{Solve for } x.",
        instruction_text="Solve for x.",
    ),
    _pc(
        "Exponential and Logarithmic Expressions",
    ...
    _pc(
        ...
        instruction_text="Interpret the tip-to-tail diagram.",
    ),
    ...
    _pc(
        ...
        "Parabolas, graphing and properties", generator="graph_quadratic", instruction_latex="\\text{Graph the parabola.}",
