# Notes — `pc_vectors_operations` (`Operations`)

- **Course:** Precalculus
- **Category:** Precalculus — Vectors
- **Generator:** `vector_basics`
...
- **D=0:** add/subtract/scalar multiply; simplest numeric/instance (per OpenStax § easy exercises).
...
|---|------|--------------|--------------|-------------|
| 0 | 101 | `$\text{Find } \langle 5, 0 \rangle - \langle 5, -1 \rangle.$` | `$\langle 0, 1 \rangle$` | evaluate/rewrite |
| 8 | 101 | `$\text{Find } \langle 1, -2 \rangle - \langle 1, -4 \rangle.$` | `$\langle 0, 2 \rangle$` | evaluate/rewrite |
| 16 | 101 | `$\text{Find } \langle 5, 1 \rangle + \langle -5, 2 \rangle.$` | `$\langle 0, 3 \rangle$` | evaluate/rewrite |
| 22 | 101 | `$\text{Find } \langle 3, -4 \rangle - \langle 0, -5 \rangle.$` | `$\langle 3, 1 \rangle$` | evaluate/rewrite |
...
|------|-----|-------------------------------------------|
| OpenStax Precalculus 2e §9.8 | https://openstax.org/books/precalculus-2e/pages/9-8-vectors | add/subtract/scalar multiply |
...
- **Reuse:** Vector component constructive.
