# Notes — `pc_vectors_basics` (`Basics`)
...
- **D=0:** component form, magnitude; simplest numeric/instance (per OpenStax § easy exercises).
...
|---|------|--------------|--------------|-------------|
| 0 | 101 | `$\text{Find } \lVert \langle 3, 0 \rangle \rVert.$` | `$3$` | evaluate/rewrite |
| 8 | 101 | `$\text{Find } \langle 3, -2 \rangle - \langle 4, -2 \rangle.$` | `$\langle -1, 0 \rangle$` | evaluate/rewrite |
| 16 | 101 | `$\text{Find } \langle 2, -2 \rangle + \langle 0, 2 \rangle.$` | `$\langle 2, 0 \rangle$` | evaluate/rewrite |
| 22 | 101 | `$\text{Find } \langle -1, -2 \rangle - \langle -3, -4 \rangle.$` | `$\langle 2, 2 \rangle$` | evaluate/rewrite |
...
|------|-----|-------------------------------------------|
| OpenStax Precalculus 2e §9.8 | https://openstax.org/books/precalculus-2e/pages/9-8-vectors | component form, magnitude |
