# Notes — `pc_right_triangle_trig_finding_ratios` (`Right triangle trig, finding ratios`)
...
- **Skill:** Student find the trigonometric ratio for right triangle trig, finding ratios.
- **D=0:** sin/cos/tan from sides; simplest numeric/instance (per OpenStax § easy exercises).
...
|---|------|--------------|--------------|-------------|
| 0 | 101 | `$\text{In right } \triangle ABC \text{ with right angle at } C,\ \text{find } \tan A.$` | `$\frac{5}{12}$` | triangle |
| 8 | 101 | `$\text{In right } \triangle ABC \text{ with right angle at } C,\ \text{find } \sin A.$` | `$\frac{9}{15}$` | triangle |
| 16 | 101 | `$\text{In right } \triangle ABC \text{ with right angle at } C,\ \text{find } \tan A.$` | `$\frac{7}{24}$` | triangle |
| 22 | 101 | `$\text{In right } \triangle ABC \text{ with right angle at } C,\ \text{find } \tan A.$` | `$\frac{7}{24}$` | triangle |
...
|------|-----|-------------------------------------------|
| OpenStax Precalculus 2e §5.4 | https://openstax.org/books/precalculus-2e/pages/5-4-right-triangle-trigonometry | sin/cos/tan from sides |
...
- **Reuse:** Geometry skeleton (right triangle ratios).
