# Notes — `pc_equations_and_multiple_angle_identities` (`Equations and Multiple-Angle Identities`)
...
- **Skill:** Student solve for x for equations and multiple-angle identities.
- **D=0:** double-angle eqn on interval; simplest numeric/instance (per OpenStax § easy exercises).
...
| 8 | 101 | `$\text{Solve }2\sin^2\theta-\sin\theta=0\text{ for }0\le\theta<2\pi.$` | `$\theta=0,\frac{\pi}{6},\pi,\frac{5\pi}{6}$` | solve |
| 16 | 101 | `$\text{Solve }2\sin^2\theta-\sin\theta=0\text{ for }0\le\theta<2\pi.$` | `$\theta=0,\frac{\pi}{6},\pi,\frac{5\pi}{6}$` | solve |
| 22 | 101 | `$\text{Solve }2\sin^2\theta-\sin\theta=0\text{ for }0\le\theta<2\pi.$` | `$\theta=0,\frac{\pi}{6},\pi,\frac{5\pi}{6}$` | solve |
...
|------|-----|-------------------------------------------|
| OpenStax Precalculus 2e §7.5 | https://openstax.org/books/precalculus-2e/pages/7-5-solving-trigonometric-equations | double-angle eqn on interval |
...
- **Variety:** Old-path table shows one prompt shape across D bands sampled (seed=101) — `$\text{Solve }2\sin^2\theta-\sin\theta=0\text{ for }0\le\theta<2\pi.$`.
