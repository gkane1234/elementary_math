# Notes — `pc_writing_polynomial_functions_and_conjugate_roots` (`Writing polynomial functions and conjugate roots`)
...
- **Skill:** Student write the polynomial function for writing polynomial functions and conjugate roots.
- **D=0:** monic poly from roots incl. conjugate pairs; simplest numeric/instance (per OpenStax § easy exercises).
...
|---|------|--------------|--------------|-------------|
| 0 | 101 | `$\text{Write the monic polynomial with roots }1+1i\text{ and }1-1i.$` | `$x^2-2x+2$` | evaluate/rewrite |
| 8 | 101 | `$\text{Write the monic polynomial with roots }3+4i\text{ and }3-4i.$` | `$x^2-6x+25$` | evaluate/rewrite |
| 16 | 101 | `$\text{Write the monic polynomial with roots }4+2i\text{ and }4-2i.$` | `$x^2-8x+20$` | evaluate/rewrite |
| 22 | 101 | `$\text{Write the monic polynomial with roots }4+2i\text{ and }4-2i.$` | `$x^2-8x+20$` | evaluate/rewrite |
...
|------|-----|-------------------------------------------|
| OpenStax Precalculus 2e §3.6 | https://openstax.org/books/precalculus-2e/pages/3-6-zeros-of-polynomial-functions | monic poly from roots incl. conjugate pairs |
...
- **Reuse:** Keep live `precalc_foundations` until dedicated skeleton; split topic branches per OpenStax section. Topic key `pc_writing_polynomial_functions_and_conjugate_roots`.
