# Notes — `a2_exponential_and_logarithmic_expressions_properties_of_logarithms`

> **LOW_VARIETY** — One template across seeds at D=0.

- **Display name:** Properties of logarithms
...
- **Skill:** Practice properties of logarithms (catalog: log_change_of_base).
...
|---|------|--------------|--------------|-------------|
| 0 | 101 | $\text{Expand: } \log_{3}\left(7^{5}\right)$ | $5\log_{3}(7)$ | form=log_properties_condense |
| 0 | 207 | $\text{Expand: } \log_{3}\left(4^{2}\right)$ | $2\log_{3}(4)$ | form=log_properties_condense |
| 8 | 101 | $\text{Expand: } \log_{5}\left(7^{5}\right)$ | $5\log_{5}(7)$ | form=log_properties_condense |
| 8 | 207 | $\text{Expand: } \log_{5}\left(4^{2}\right)$ | $2\log_{5}(4)$ | form=log_properties_condense |
| 16 | 101 | $\text{Expand: } \log_{5}\left(7^{5}\right)$ | $5\log_{5}(7)$ | form=log_properties_condense |
| 16 | 207 | $\text{Expand: } \log_{12}\left(5^{3}\right)$ | $3\log_{12}(5)$ | form=log_properties_condense |
| 22 | 101 | $\text{Expand: } \log_{5}\left(7^{5}\right)$ | $5\log_{5}(7)$ | form=log_properties_condense |
| 22 | 207 | $\text{Expand: } \log_{12}\left(5^{3}\right)$ | $3\log_{12}(5)$ | form=log_properties_condense |
