# Notes — `pc_compound_interest` (`Compound interest`)

- **Course:** Precalculus
- **Category:** Precalculus — Exponential and Logarithmic Expressions
- **Generator:** `compound_interest`
- **Suggested family:** wp
...
- **Skill:** Student solve the problem for compound interest.
- **D=0:** A=P(1+r/n)^{nt} application; simplest numeric/instance (per OpenStax § easy exercises).
...
|---|------|--------------|--------------|-------------|
| 0 | 101 | `$\text{An account starts with } \$2000 \text{ and earns } 4\% \text{ interest compounded annually for } 3 \text{ years.} \text{ What is the ending balance?}$` | `$\$2249.73$` | evaluate/rewrite |
| 8 | 101 | `$\text{An account starts with } \$1000 \text{ and earns } 5\% \text{ interest compounded annually for } 3 \text{ years.} \text{ How much interest is earned?}$` | `$\$157.63$` | evaluate/rewrite |
| 16 | 101 | `$\text{An account starts with } \$8000 \text{ at } 8\% \text{ interest compounded quarterly for } 5 \text{ years.} \text{ What is the ending balance?}$` | `$\$11887.58$` | evaluate/rewrite |
| 22 | 101 | `$\text{An account starts with } \$2000 \text{ at } 9\% \text{ interest compounded semiannually for } 10 \text{ years.} \text{ How much interest is earned?}$` | `$\$2823.43$` | evaluate/rewrite |
...
|------|-----|-------------------------------------------|
| OpenStax Precalculus 2e §4.7 | https://openstax.org/books/precalculus-2e/pages/4-7-exponential-and-logarithmic-models | A=P(1+r/n)^{nt} application |

Local HTML (if mined): `textbooks/openstax/html/precalculus-2e/…` or `scripts/output/example_mining/precalculus-2e/stage1/4-7-exponential-and-logarithmic-models.md`
...
- **Reuse:** WP packaging on exp/log core.
