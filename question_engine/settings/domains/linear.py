...
def more_on_slope_settings() -> list[SettingField]:
    ...
    return [
        ...
        SettingField(
            "allow_from_equation",
            "Allow find slope from an equation",
            "bool",
            True,
            group="slope",
        ),
        ...
        SettingField(
            "equation_form",
            "Equation form for slope-from-equation",
            "select",
            "mixed",
            options=["mixed", "slope_intercept", "point_slope", "standard"],
            group="slope",
        ),
        SettingField(
            "allow_slope_intercept_form",
            "Allow y = mx + b form",
            "bool",
            True,
            group="slope",
        ...
        SettingField(
            "allow_point_slope_form",
            "Allow point-slope form",
            "bool",
            True,
            group="slope",
        ),
        SettingField(
            "allow_standard_form",
            "Allow standard form Ax + By = C",
            "bool",
            True,
            group="slope",
        ),
        SettingField(
            "graph_for_two_points",
            "Include blank graph for two-point prompts",
            "bool",
            False,
            group="slope",
        ),
