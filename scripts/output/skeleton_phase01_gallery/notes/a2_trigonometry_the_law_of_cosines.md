# Notes — `a2_trigonometry_the_law_of_cosines`

> **LOW_VARIETY** — One template across seeds at D=0.

- **Display name:** Law of Cosines
...
- **Skill:** Practice law of cosines (catalog: law_of_cosines).
...
|---|------|--------------|--------------|-------------|
| 0 | 101 | $\text{In } \triangle ABC,\ a = 8,\ b = 9,\ m\angle C = 60^\circ.\ \text{Find } c \text{ (Law of Cosines).}$ | $8.54$ | — |
| 0 | 207 | $\text{In } \triangle ABC,\ a = 10,\ b = 10,\ m\angle C = 60^\circ.\ \text{Find } c \text{ (Law of Cosines).}$ | $10.00$ | — |
| 8 | 101 | $\text{In } \triangle ABC,\ a = 12,\ b = 8,\ m\angle C = 40^\circ.\ \text{Find } c \text{ (Law of Cosines).}$ | $7.81$ | — |
| 8 | 207 | $\text{In } \triangle ABC,\ a = 15,\ b = 7,\ m\angle C = 30^\circ.\ \text{Find } c \text{ (Law of Cosines).}$ | $9.60$ | — |
| 16 | 101 | $\text{In } \triangle ABC,\ a = 13,\ b = 16,\ m\angle C = 40^\circ.\ \text{Find } c \text{ (Law of Cosines).}$ | $10.31$ | — |
| 16 | 207 | $\text{In } \triangle ABC,\ a = 15,\ b = 21,\ m\angle C = 120^\circ.\ \text{Find } c \text{ (Law of Cosines).}$ | $31.32$ | — |
| 22 | 101 | $\text{In } \triangle ABC,\ a = 7,\ b = 20,\ m\angle C = 80^\circ.\ \text{Find } c \text{ (Law of Cosines).}$ | $20.01$ | — |
| 22 | 207 | $\text{In } \triangle ABC,\ a = 25,\ b = 22,\ m\angle C = 100^\circ.\ \text{Find } c \text{ (Law of Cosines).}$ | $36.06$ | — |
...
- **Reuse:** Existing `law_of_cosines` hand path until a skeleton exists.
- **New:** only if no honest match — leave leaf and document skip.
- **Not this pass:** notes only; no generator implementation.

_Catalog generator `law_of_cosines`; equations/WP agent owns solve/WP siblings._
