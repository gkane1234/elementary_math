# Notes — `pc_inverse_trig_functions` (`Inverse trig functions`)

- **Course:** Precalculus
- **Category:** Precalculus — Trigonometry
- **Generator:** `inverse_trig_functions`
...
- **Skill:** Student evaluate the inverse trigonometric function for inverse trig functions.
- **D=0:** evaluate arcsin/arccos/arctan; simplest numeric/instance (per OpenStax § easy exercises).
...
|---|------|--------------|--------------|-------------|
| 0 | 101 | `$\arccos\left(\frac{1}{2}\right)$` | `$\frac{\pi}{3}$` | evaluate/rewrite |
| 8 | 101 | `$\arctan\left(1\right)$` | `$\frac{\pi}{4}$` | evaluate/rewrite |
| 16 | 101 | `$\arcsin\left(0\right)$` | `$0$` | evaluate/rewrite |
| 22 | 101 | `$\arcsin\left(1\right)$` | `$\frac{\pi}{2}$` | evaluate/rewrite |
...
|------|-----|-------------------------------------------|
| OpenStax Precalculus 2e §6.3 | https://openstax.org/books/precalculus-2e/pages/6-3-inverse-trigonometric-functions | evaluate arcsin/arccos/arctan |

Local HTML (if mined): `textbooks/openstax/html/precalculus-2e/…` or `scripts/output/example_mining/precalculus-2e/stage1/6-3-inverse-trigonometric-functions.md`
...
- **Reuse:** Inverse trig eval constructive.
