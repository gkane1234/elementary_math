# Notes — `a2_conic_sections_circles_writing_equations`

> **LOW_VARIETY** — One template across seeds at D=0.

- **Display name:** Circles writing equations
...
- **Skill:** Practice circles writing equations (catalog: conic_sections).
...
|---|------|--------------|--------------|-------------|
| 0 | 101 | $\text{Write the equation of the circle with center }(0,0)\text{ and radius }4.$ | $x^2+y^2=16$ | — |
| 0 | 207 | $\text{Write the equation of the circle with center }(0,0)\text{ and radius }4.$ | $x^2+y^2=16$ | — |
| 8 | 101 | $\text{Write the equation of the circle with center }(1,3)\text{ and radius }3.$ | $(x-(1))^2+(y-(3))^2=9$ | — |
| 8 | 207 | $\text{Write the equation of the circle with center }(1,2)\text{ and radius }6.$ | $(x-(1))^2+(y-(2))^2=36$ | — |
| 16 | 101 | $\text{Write the equation of the circle with center }(4,-2)\text{ and radius }6.$ | $(x-(4))^2+(y-(-2))^2=36$ | — |
| 16 | 207 | $\text{Write the equation of the circle with center }(3,5)\text{ and radius }7.$ | $(x-(3))^2+(y-(5))^2=49$ | — |
| 22 | 101 | $\text{Write the equation of the circle with center }(3,-3)\text{ and radius }7.$ | $(x-(3))^2+(y-(-3))^2=49$ | — |
| 22 | 207 | $\text{Write the equation of the circle with center }(2,4)\text{ and radius }5.$ | $(x-(2))^2+(y-(4))^2=25$ | — |
