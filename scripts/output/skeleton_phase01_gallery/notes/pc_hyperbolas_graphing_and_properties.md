# Notes — `pc_hyperbolas_graphing_and_properties` (`Hyperbolas, graphing and properties`)
...
- **Skill:** Student graph the hyperbola for hyperbolas, graphing and properties.
- **D=0:** graph hyperbola asymptotes; simplest numeric/instance (per OpenStax § easy exercises).
...
|---|------|--------------|--------------|-------------|
| 0 | 101 | `$\frac{y^2}{9}-\frac{x^2}{16}=1$` | `$a=3,\ b=4,\ \text{vertical}$` | evaluate/rewrite |
| 8 | 101 | `$\frac{y^2}{36}-\frac{x^2}{9}=1$` | `$a=6,\ b=3,\ \text{vertical}$` | evaluate/rewrite |
| 16 | 101 | `$\frac{y^2}{25}-\frac{x^2}{49}=1$` | `$a=5,\ b=7,\ \text{vertical}$` | evaluate/rewrite |
| 22 | 101 | `$\frac{y^2}{121}-\frac{x^2}{25}=1$` | `$a=11,\ b=5,\ \text{vertical}$` | evaluate/rewrite |
...
|------|-----|-------------------------------------------|
| OpenStax Precalculus 2e §10.4 | https://openstax.org/books/precalculus-2e/pages/10-4-the-hyperbola | graph hyperbola asymptotes |
