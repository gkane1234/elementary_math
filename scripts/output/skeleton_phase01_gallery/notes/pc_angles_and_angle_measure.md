# Notes — `pc_angles_and_angle_measure` (`Angles and angle measure`)
...
- **Skill:** Student find the measure for angles and angle measure.
- **D=0:** degree/radian conversion, coterminal; simplest numeric/instance (per OpenStax § easy exercises).
...
|---|------|--------------|--------------|-------------|
| 0 | 101 | `$\text{Convert }150^\circ\text{ to radians.}$` | `$\frac{5\pi}{6}$` | evaluate/rewrite |
| 8 | 101 | `$\text{Convert }90^\circ\text{ to radians.}$` | `$\frac{\pi}{2}$` | evaluate/rewrite |
| 16 | 101 | `$\text{Convert }180^\circ\text{ to radians.}$` | `$\pi$` | evaluate/rewrite |
| 22 | 101 | `$\text{Convert }120^\circ\text{ to radians.}$` | `$\frac{2\pi}{3}$` | evaluate/rewrite |
...
|------|-----|-------------------------------------------|
| OpenStax Precalculus 2e §5.1 | https://openstax.org/books/precalculus-2e/pages/5-1-angles | degree/radian conversion, coterminal |
...
- **Reuse:** Keep live `precalc_foundations` until dedicated skeleton; split topic branches per OpenStax section. Topic key `pc_angles_and_angle_measure`.
