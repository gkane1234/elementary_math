# Notes — `a2_quadratic_functions_and_inequalities_solving_equations_by_taking_square_roots`

> **LIMITATIONS** — Gallery stub; Limitations below. Live old-path samples not yet pasted.

- **Display name:** Solving equations by taking square roots
...
- **Skill:** Solving equations by taking square roots (catalog: `quadratic_square_roots`).
...
|------|-----|-------------------------------------------|
| OpenStax Intermediate Algebra 2e §9.1 | https://openstax.org/books/intermediate-algebra-2e/pages/9-1-solve-quadratic-equations-using-the-square-root-property | Isolate then ±√; a≠1 later |
