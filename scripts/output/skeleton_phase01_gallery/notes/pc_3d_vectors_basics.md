# Notes — `pc_3d_vectors_basics` (`Basics`)

> **LOW_VARIETY**

- **Course:** Precalculus
- **Category:** Precalculus — Three-Dimensional Vectors
- **Generator:** `vector_3d_basics`
...
- **Skill:** Student evaluate for basics.
- **D=0:** 3D magnitude/components; simplest numeric/instance (per OpenStax § easy exercises).
...
|---|------|--------------|--------------|-------------|
| 0 | 101 | `$\text{Find the magnitude of }\langle 1,4,8\rangle.$` | `$9$` | evaluate/rewrite |
| 8 | 101 | `$\text{Find the magnitude of }\langle 1,4,8\rangle.$` | `$9$` | evaluate/rewrite |
| 16 | 101 | `$\text{Find the magnitude of }\langle 1,4,8\rangle.$` | `$9$` | evaluate/rewrite |
| 22 | 101 | `$\text{Find the magnitude of }\langle 1,4,8\rangle.$` | `$9$` | evaluate/rewrite |
...
|------|-----|-------------------------------------------|
| OpenStax Precalculus 2e §9.8 | https://openstax.org/books/precalculus-2e/pages/9-8-vectors | 3D magnitude/components |
...
- **Variety:** Old-path table shows one prompt shape across D bands sampled (seed=101) — `$\text{Find the magnitude of }\langle 1,4,8\rangle.$`.
