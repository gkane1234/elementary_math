...
- Shipped on SolveLinear. LIMITATIONS: WP dump stays on one_step_wp (opt-out stub), not this leaf.
- D climb: integers → negatives → x/a fractions; avoid two-step shapes.
