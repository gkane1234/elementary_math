# Notes — `pc_trig_functions_of_any_angle` (`Trig functions of any angle`)
...
- **Skill:** Student evaluate the trigonometric function for trig functions of any angle.
- **D=0:** eval sin/cos/tan on any angle (unit circle); simplest numeric/instance (per OpenStax § easy exercises).
...
|---|------|--------------|--------------|-------------|
| 0 | 101 | `$\sin\left(0^\circ\right)$` | `$0$` | evaluate/rewrite |
| 8 | 101 | `$\cos\left(150^\circ\right)$` | `$-\frac{\sqrt{3}}{2}$` | evaluate/rewrite |
| 16 | 101 | `$\cos\left(330^\circ\right)$` | `$\frac{\sqrt{3}}{2}$` | evaluate/rewrite |
| 22 | 101 | `$\cot\left(225^\circ\right)$` | `$1$` | evaluate/rewrite |
...
|------|-----|-------------------------------------------|
| OpenStax Precalculus 2e §5.3 | https://openstax.org/books/precalculus-2e/pages/5-3-the-other-trigonometric-functions | eval sin/cos/tan on any angle (unit circle) |

Local HTML (if mined): `textbooks/openstax/html/precalculus-2e/…` or `scripts/output/example_mining/precalculus-2e/stage1/5-3-the-other-trigonometric-functions.md`
...
- **Reuse:** Unit-circle / any-angle eval skeleton.
