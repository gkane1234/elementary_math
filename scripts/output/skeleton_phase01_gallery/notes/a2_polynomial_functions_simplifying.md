...
- **Skill:** Practice simplifying (catalog: simplify_polynomials).
...
Live `_generate_for_type` with opt-out `{"use_sample_expand_simplify": true}`.

| D | seed | prompt_latex | answer_latex | shape notes |
|---|------|--------------|--------------|-------------|
| 0 | 101 | $2 + x^{2}$ | $x^{2} + 2$ | pattern=PolySimplify |
| 0 | 207 | $2x^{2} + 3$ | $2x^{2} + 3$ | pattern=PolySimplify |
| 8 | 101 | $x^{3} + 2 + 2x^{2} - x^{2}$ | $x^{3} + x^{2} + 2$ | pattern=PolySimplify |
| 8 | 207 | $-7 + 6 + x + 3x^{3}$ | $3x^{3} + x - 1$ | pattern=PolySimplify |
| 16 | 101 | $-2\left(-2x^{4} - 4\right) - x^{4} + x^{2} + 2x - 4$ | $3x^{4} + x^{2} + 2x + 4$ | pattern=PolySimplify |
| 16 | 207 | $2\left(x^{4} + 1\right) - 2\left(x^{4} + 2\right) + x^{4} + x^{2} + 3x$ | $x^{4} + x^{2} + 3x - 2$ | pattern=PolySimplify |
| 22 | 101 | $-2\left(-2x^{4} - 4\right) - x^{4} + x^{2} + 2x - 4$ | $3x^{4} + x^{2} + 2x + 4$ | pattern=PolySimplify |
| 22 | 207 | $2\left(x^{4} + 1\right) - 2\left(x^{4} + 2\right) + x^{4} + x^{2} + 3x$ | $x^{4} + x^{2} + 3x - 2$ | pattern=PolySimplify |

Opt-out flag used: `{"use_sample_expand_simplify": true}`

## A1 alias comparison

- **A1 catalog twin:** `simplify_polynomials` (same generator `simplify_polynomials` unless noted).
- **Old path vs A1:** Differs from A1 alias at some D/seeds — see samples; verify catalog intent.
  - D=0.0 seed=207: A2 `2x^{2} + 3` ≠ A1 `2x^{2} + 2`
  - D=8.0 seed=101: A2 `x^{3} + 2 + 2x^{2} - x^{2}` ≠ A1 `5x^{3} + 2x^{2} - x - 3x^{3}`
  - D=8.0 seed=207: A2 `-7 + 6 + x + 3x^{3}` ≠ A1 `-5 + 6 - x^{2} + 3x^{3}`
  - D=16.0 seed=101: A2 `-2\left(-2x^{4} - 4\right) - x^{4} + x^{2} + 2x - 4` ≠ A1 `x^{4} + 3x^{3} + x^{2} + 7 + 3\left(x^{4} - 1\right)`
  - D=16.0 seed=207: A2 `2\left(x^{4} + 1\right) - 2\left(x^{4} + 2\right) + x^{4} + x^{2} + 3x` ≠ A1 `2\left(x^{4} + 1\right) - 2\left(x^{4} + 2\right) + x^{4} + x^{3} - 2x + 5`
  - D=22.0 seed=101: A2 `-2\left(-2x^{4} - 4\right) - x^{4} + x^{2} + 2x - 4` ≠ A1 `x^{4} + 3x^{3} + x^{2} + 7 + 3\left(x^{4} - 1\right)`
  - D=22.0 seed=207: A2 `2\left(x^{4} + 1\right) - 2\left(x^{4} + 2\right) + x^{4} + x^{2} + 3x` ≠ A1 `2\left(x^{4} + 1\right) - 2\left(x^{4} + 2\right) + x^{4} + x^{3} - 2x + 5`
...
- **Reuse:** Existing skeleton slug `simplify_polynomials` / shared `simplify_polynomials` family.
- **New:** only if no honest match — leave leaf and document skip.
- **Not this pass:** notes only; no generator implementation.

_Catalog generator `simplify_polynomials`; equations/WP agent owns solve/WP siblings._
